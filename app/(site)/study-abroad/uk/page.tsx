...
const ukData = {
  ...
  description:
    "The UK offers world-class education with 4 universities in QS Top 10. Nepali students can work 20 hours/week during term and full-time during holidays. Graduate Route allows 2 years post-study work (3 years for PhD).",
  stats: {
    universities: "150+",
  ...
  universities: [
    ...
    },
    {
      ...
      rank: "QS #5",
      location: "Cambridge",
      popular: "Engineering, CS, Economics",
      nepaliStudents: "80+",
    },
    {
    ...
    },
    {
      ...
      rank: "QS #9",
      location: "London",
      popular: "Architecture, Law, Psychology",
      nepaliStudents: "800+",
    },
    {
      ...
      rank: "QS #27",
      location: "Edinburgh",
      popular: "AI, Data Science, Business",
      nepaliStudents: "400+",
    },
    {
      ...
      rank: "QS #34",
      location: "Manchester",
      popular: "Engineering, Business, Pharmacy",
      nepaliStudents: "600+",
    },
  ],
  cities: [
    {
      name: "London",
      universities: "Imperial (QS #2), UCL (QS #9), LSE (QS #50)",
      highlight: "Global Financial Hub",
      students: "5,000+ Nepali students",
      livingCost: "£1,300-£1,500/month",
    },
    {
      name: "Manchester",
      universities: "University of Manchester (QS #34)",
      highlight: "Affordable Living",
      students: "2,000+ Nepali students",
      livingCost: "£900-£1,100/month",
    },
    {
      name: "Edinburgh",
      universities: "University of Edinburgh (QS #27)",
      highlight: "Scottish Capital",
      students: "1,500+ Nepali students",
      livingCost: "£1,000-£1,200/month",
    },
    {
      name: "Birmingham",
      universities: "University of Birmingham (QS #80)",
      highlight: "Second Largest City",
      students: "1,200+ Nepali students",
      livingCost: "£850-£1,000/month",
    },
    {
      name: "Glasgow",
      universities: "University of Glasgow (QS #78)",
      highlight: "Scottish Culture",
      students: "1,000+ Nepali students",
      livingCost: "£800-£950/month",
    },
  ],
  offices: [
    {
  ...
  costBreakdown: {
    ...
    livingLondon: {
      min: 13761,
      max: 13761,
      period: "9 months (London £1,529/mo)",
      nprMin: 2339370,
      nprMax: 2339370,
    },
    livingOutside: {
      min: 10539,
      max: 10539,
      period: "9 months (outside London £1,171/mo)",
      nprMin: 1791630,
      nprMax: 1791630,
    },
  ...
  scholarships: [
    {
      ...
      amount: "Full tuition + £1,100/month stipend",
    ...
    },
    {
      ...
      amount: "£10,000",
      eligibility: "Specific countries including Nepal",
    },
    {
      name: "University-specific scholarships",
      amount: "£2,000-£10,000",
      eligibility: "Merit-based, varies by university",
    },
    {
      name: "British Council Scholarships",
      amount: "Full/Partial funding",
      eligibility: "Women in STEM, specific subjects",
    },
  ],
  testimonials: [
    {
      ...
      quote:
        "My UK visa was granted within just 24 hrs of biometric. Thankyou all SAN Marina team.",
      verified: true,
      rating: 5,
      date: "7 months ago",
    },
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes. The UK visa process from Nepal is handled via VFS Global in Kathmandu. Applicants from Kathmandu, Dang, Itahari, and across Nepal submit online, then attend biometrics at the Kathmandu centre. Processing typically 3 weeks.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "UK visa process from Nepal: standard 3 weeks from biometrics. Priority (5 days) and super-priority (24 hours) cost extra. Most Nepali applicants receive decisions within 2–3 weeks when documents are complete.",
    },
    {
      question: "Is IELTS mandatory? Can I study in UK without IELTS?",
      answer:
        "IELTS UKVI is standard (6.0+, no band below 5.5). Study in UK without IELTS is possible via English-medium degree exemption, PTE Academic UKVI, TOEFL iBT, Duolingo (some universities), or pre-sessional courses. Check your university.",
    },
    {
      question: "What is CAS and why do I need it for UK student visa?",
      answer:
        "CAS (Confirmation of Acceptance for Studies) is a unique reference from your UK university after you accept an offer and pay deposit. It lists your course, fees, and details. You cannot apply for UK student visa without CAS.",
    },
    {
      question: "Can I switch from Graduate Route to Skilled Worker visa?",
      answer:
        "Yes. During or after your Graduate Route period, you can apply for a Skilled Worker visa if you secure a job with a licensed sponsor. Many Nepali graduates use this pathway for long-term UK residence.",
    },
    {
      question: "When are the intakes to study in UK from Nepal?",
      answer:
        "UK universities offer September (main intake) and January (secondary). Most courses begin in September. Apply via UCAS for undergraduate; direct application for postgraduate. Apply 6–9 months before your intended start date.",
    },
    {
      question:
        "What types of accommodation are available for Nepali students in UK?",
      answer:
        "On-campus halls (£100–250/week), shared houses (£80–150/week), private flats (£150–300/week). London costs more than Manchester, Birmingham, Glasgow, or Edinburgh. Many universities guarantee first-year accommodation.",
    },
  ],
};
...
const comparisonData = [
  {
    country: "UK",
    countrySlug: null,
    tuition: "£10,000-38,000",
    living: "£10,539-13,761",
    work: "20 hrs/week",
    psw: "2 Years (PhD 3)",
    visaTime: "3 weeks",
  },
  ...
  {
    country: "Canada",
    countrySlug: "/study-abroad/can/",
    tuition: "CAD $15,000-35,000",
    living: "CAD $22,895+/year",
    work: "20 hrs/week",
    psw: "1-3 Years",
    visaTime: "4-12 weeks",
  },
    ...
    "@graph": [
      {
        ...
        publisher: {
          ...
          logo: {
            "@type": "ImageObject",
            url: "https://www.sanmarina.edu.np/logo.png",
          },
        },
      },
      {
      ...
      },
      {
        ...
        step: [
          {
            "@type": "HowToStep",
            name: "Apply to UK universities",
            text: "Apply to UK universities and receive offer letter.",
          },
          {
            "@type": "HowToStep",
            name: "Accept offer and pay deposit",
            text: "Accept offer and pay tuition deposit (usually £2,000-£5,000).",
          },
          {
            "@type": "HowToStep",
            name: "Receive CAS",
            text: "Receive CAS (Confirmation of Acceptance for Studies).",
          },
          {
            "@type": "HowToStep",
            name: "Prepare financial documents",
            text: "Prepare financial documents (28 days in bank).",
          },
          {
            "@type": "HowToStep",
            name: "Complete TB test",
            text: "Complete TB test at approved clinic.",
          },
          {
            "@type": "HowToStep",
            name: "Apply online",
            text: "Apply online via the official UK visa application portal.",
          },
          {
            "@type": "HowToStep",
            name: "Pay visa fee and IHS",
            text: "Pay visa fee (£527) and IHS (£776/year).",
          },
          {
            "@type": "HowToStep",
            name: "Book biometric appointment",
            text: "Book biometric appointment at VFS Global.",
          },
          {
            "@type": "HowToStep",
            name: "Submit documents",
            text: "Submit documents and attend interview (if required).",
          },
          {
            "@type": "HowToStep",
            name: "Receive decision",
            text: "Receive decision (typically 3 weeks).",
          },
        ],
      },
      {
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 lg:px-24 py-20">
          <nav className="text-sm text-blue-200 mb-6 pt-3">
            <Link href="/" className="hover:text-white">
              Home
            </Link>
            <ChevronRight className="inline mx-2" size={14} />
            <Link href="/study-abroad/" className="hover:text-white">
              Study Abroad
            </Link>
            <ChevronRight className="inline mx-2" size={14} />
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="/contact/"
              className="inline-flex items-center gap-2 bg-white/20 text-white border-2 border-white px-6 py-3 rounded-xl font-bold hover:bg-white/30 transition-all"
            >
              Apply Now
            </Link>
            <a
      ...
      <section className="py-4 bg-white border-b border-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xs text-gray-500 mt-2">
            By {ukData.author.name} · {ukData.author.role} ·{" "}
            {ukData.author.expertise}
          </p>
        </div>
      </section>
            ...
            <table className="w-full bg-white rounded-xl shadow-sm text-sm">
              <tbody>
                <tr className="border-b border-gray-100">
                  <td className="p-3 font-semibold text-[#001F3F] w-1/3">
                    Tuition
                  </td>
                  <td className="p-3">£10,000–38,000/year</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3 font-semibold text-[#001F3F]">
                    London maintenance
                  </td>
                  <td className="p-3">£13,761 (9 months)</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3 font-semibold text-[#001F3F]">
                    Outside London
                  </td>
                  <td className="p-3">£10,539 (9 months)</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3 font-semibold text-[#001F3F]">Visa fee</td>
                  <td className="p-3">£527</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3 font-semibold text-[#001F3F]">IHS</td>
                  <td className="p-3">£776/year</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3 font-semibold text-[#001F3F]">
                    Graduate Route
                  </td>
                  <td className="p-3">2 years (3 years PhD)</td>
                </tr>
                <tr>
                  <td className="p-3 font-semibold text-[#001F3F]">
                    Part-time work
                  </td>
                  <td className="p-3">20 hrs/week during term</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-4 font-medium">
          <strong>In brief:</strong> The UK combines prestige with
          practicality—four QS Top 10 institutions, one-year Master&apos;s
          programmes, and the{" "}
          <Link
            href="#graduate-route"
            className="text-blue-600 hover:underline"
          ...
          (London) or £10,539 (outside London).
        </p>
        <div className="prose prose-lg max-w-none text-gray-700">
          <p className="mb-4">
            For generations, the United Kingdom has drawn ambitious students
            from around the world. Today,{" "}
            <strong>four of the QS World Top 10</strong> universities call the
            UK home—and that reputation translates into employability. Employers
            recognise UK degrees for their rigour, critical thinking, and
            research-led teaching.
          </p>
          <p className="mb-4">
            What sets the UK apart for many Nepali families is efficiency: a
            three-year Bachelor&apos;s, a one-year Master&apos;s, and then the{" "}
            <Link
              href="#graduate-route"
              className="text-blue-600 hover:underline"
            >
            ...
            through VFS in Kathmandu; applicants from Dang, Itahari, and across
            the country typically receive decisions within three weeks.
          </p>
          <p className="mb-4">
            Once there, you&apos;ll join over 30,000 Nepali students in London,
            Manchester, Edinburgh, and beyond. The diaspora is active—student
            associations, cultural events, and informal networks make the
            transition smoother than many expect.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-6">
            ...
            university, proof of English (IELTS UKVI 6.0+ or equivalent), and
            funds for tuition plus maintenance (£13,761 for London, £10,539
            outside—held for 28 days). Add a TB test and valid passport. Visa
            fee £527; IHS £776 per year.
          </p>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-700 mb-6">
          <strong>In brief:</strong> Shorter degrees mean lower cost and faster
          entry to the job market. One-year Master&apos;s programmes, four QS
          Top 10 universities, and two years of Graduate Route work rights make
          the UK a strong option for career-focused applicants.
        </p>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-6">
            <strong>In brief:</strong> Shorter courses, part-time work during
            term (20 hrs/week), and two years of post-study work under the
            Graduate Route. You gain a globally recognised degree and
            international experience without the multi-year commitment required
            elsewhere.
          </p>
            ...
            {[
              {
                ...
                desc: "1-year Master's vs 2 years elsewhere; 3-year Bachelor's",
              },
              {
                title: "Part-Time Work",
                desc: "20 hrs/week during term; full-time during holidays",
              },
              {
                title: "Graduate Route",
                desc: "2 years post-study work (3 years for PhD)",
              },
              {
                title: "Global Recognition",
                desc: "UK degrees valued by employers worldwide",
              },
              {
                title: "Research Excellence",
                desc: "Russell Group universities lead research",
              },
              {
                title: "English Immersion",
                desc: "Improve language skills in native environment",
              },
            ].map((item, i) => (
              <div
                key={i}
      ...
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-700 mb-4">
          <strong>In brief:</strong> A few routes exist: an English-medium
          degree can exempt you; many universities accept PTE, TOEFL, or
          Duolingo; and pre-sessional courses let you meet the requirement on
          arrival. For the standard{" "}
          <Link href="/services/" className="text-blue-600 hover:underline">
            UK IELTS requirement
          </Link>{" "}
          and test prep, see our services page.
        </p>
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          <li>
            English-medium degree from recognised institution: may exempt IELTS
          </li>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-6">
            ...
            per week; during vacations, full-time. Minimum wage is £11.44/hour
            for those 21 and over. After graduation, the Graduate Route gives
            you two years (three for PhD) of unrestricted work—no sponsorship
            needed.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              ...
              <p className="text-gray-700">
                20 hrs/week during term; full-time during holidays. No separate
                work permit.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              <h3 className="font-bold text-[#001F3F] mb-3">
                After Graduation
              </h3>
              <p className="text-gray-700">
                Graduate Route: 2 years (bachelor/master), 3 years (PhD). Any
                skill level, no job offer needed.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-700 mb-4">
          <strong>In brief:</strong> Study in UK for international students
          means securing a Student Route visa with a CAS, financial proof
          (£13,761 in London, £10,539 outside), and proof of English. Over
          600,000 international students study in the UK—Nepali students are a
          growing and visible community in London, Manchester, and Edinburgh.
        </p>
        <p className="text-gray-700">
          Families from Kathmandu, Dang, Itahari, and nationwide come to us for
          UK guidance because the process—while clear—benefits from experience.
          We help with university shortlisting, CAS preparation, and document
          checks so your application reflects your strongest case.
        </p>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-2xl font-bold text-[#001F3F] mb-2">
                £{ukData.costBreakdown.tuition.min.toLocaleString()}-£
                {ukData.costBreakdown.tuition.max.toLocaleString()}
              </p>
              <p className="text-gray-600 text-sm mb-2">
                {ukData.costBreakdown.tuition.period}
              </p>
              <p className="text-green-600 text-sm">
                NPR {ukData.costBreakdown.tuition.nprMin.toLocaleString()}-
                {ukData.costBreakdown.tuition.nprMax.toLocaleString()}
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm mb-2">
                {ukData.costBreakdown.livingLondon.period}
              </p>
              <p className="text-green-600 text-sm">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm mb-2">
                {ukData.costBreakdown.livingOutside.period}
              </p>
              <p className="text-green-600 text-sm">
                NPR {ukData.costBreakdown.livingOutside.nprMin.toLocaleString()}{" "}
                (1 GBP ≈ 170 NPR)
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600 text-sm mb-2">
                {ukData.costBreakdown.ihs.period}
              </p>
              <p className="text-green-600 text-sm">
          ...
          <div className="mt-8 bg-blue-50 rounded-2xl p-6">
            <h3 className="font-bold text-[#001F3F] mb-4">
              Total Cost to Study in UK from Nepal (1 Year)
            </h3>
            ...
            <p className="text-sm text-gray-600">
              Cost to study in UK from Nepal varies by university and city.{" "}
              <Link
                href="/scholarships/"
                className="text-blue-600 hover:underline"
              >
            ...
            <table className="w-full bg-white rounded-xl shadow-sm text-sm max-w-2xl">
              <thead>
                <tr className="bg-[#001F3F] text-white">
                  ...
                  <th className="p-3 text-left">Typical range/year</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-100">
                  <td className="p-3">Foundation / Pre-Master&apos;s</td>
                  <td className="p-3">£10,000–18,000</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3">Bachelor&apos;s</td>
                  <td className="p-3">£12,000–28,000</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3">Master&apos;s</td>
                  <td className="p-3">£15,000–38,000</td>
                </tr>
                <tr>
                  <td className="p-3">PhD</td>
                  <td className="p-3">£18,000–25,000 (often funded)</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <h3 className="font-bold text-[#001F3F] mb-4">
            Accommodation for Nepali Students in UK
          </h3>
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-xl shadow-sm text-sm max-w-2xl">
              <thead>
                <tr className="bg-[#001F3F] text-white">
                  ...
                  <th className="p-3 text-left">Weekly (approx)</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-100">
                  <td className="p-3">On-campus halls</td>
                  <td className="p-3">£100–250</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3">Shared house (outside London)</td>
                  <td className="p-3">£80–150</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="p-3">Private flat (London)</td>
                  <td className="p-3">£200–300</td>
                </tr>
                <tr>
                  <td className="p-3">Homestay</td>
          ...
          <p className="text-sm text-gray-600 mt-2">
            Many universities guarantee first-year accommodation for
      ...
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-700 mb-4">
          ...
          intake) and January (secondary intake). Most courses begin in
          September. Apply via UCAS for undergraduate programmes; direct
          application for postgraduate. Apply 6–9 months before your intended
          start date.
        </p>
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-blue-50 p-4 rounded-xl border border-blue-100">
            ...
            <p className="text-gray-700 text-sm">
              Most courses; largest selection. UCAS deadline typically January
              for UG.
            </p>
          </div>
          <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
            ...
            <p className="text-gray-700 text-sm">
              Fewer courses; common for postgraduate and business programmes.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
          ...
          documents ready, you apply online and book biometrics at VFS Global in
          Kathmandu. Most applicants receive a decision within three weeks. Visa
          fee £527; IHS £776 per year.
        </p>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8">
          <h3 className="text-xl font-bold text-[#001F3F] mb-4">
            Financial Requirements (28 Days)
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="text-gray-700">
                First year tuition fees must be in your bank account OR paid to
                the university. If partially paid, show remaining balance.
              </p>
            </div>
            <div>
              <h4 className="font-semibold text-[#001F3F] mb-2">
          ...
          <p className="mt-4 text-sm text-gray-600">
            Funds must be held for consecutive 28 days before application. Bank
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 text-center shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Retail, Hospitality, Customer Service, Campus roles
              </p>
            </div>
          </div>
        </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Stay and work in UK for 2 years after graduation (3 years
                    for PhD)
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Work at any skill level, no job offer needed
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    ...
                    during or after Graduate Route
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">
                    Dependents can join you during Graduate Route
                  </p>
                </div>
              </li>
            </ul>
      ...
      <section id="scholarships" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-6 max-w-2xl mx-auto">
            ...
            including UK-specific awards. Below are key options for Nepali
            applicants.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-2 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {ukData.testimonials.map((testimonial, i) => (
              <blockquote
                key={i}
                className="bg-blue-50 rounded-2xl p-8 border-l-4 border-blue-600"
              >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-4 text-center">
            Why Trust San Marina for Your UK Study Journey?
          </h2>
          <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
            We handle the full journey—CAS preparation, document checks, VFS
            submissions, and Graduate Route planning. Our direct partnerships
            with 100+ UK universities, combined with{" "}
            <Link href="/about/" className="text-blue-600 hover:underline">
              QEAC and PIER certification
            </Link>
            , mean your application is in experienced hands.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              {
                value: "High",
                label: "Visa Success for Genuine Applicants",
                icon: CheckCircle2,
              },
              {
                value: ukData.authority.experience,
                label: "Years Experience",
                icon: Clock,
              },
              {
                value: ukData.authority.studentsPlaced,
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            {ukData.authority.certifications.map((cert, i) => (
              <span
                key={i}
                className="inline-flex items-center gap-2 bg-blue-100 text-[#0056b3] px-4 py-2 rounded-full text-sm font-semibold"
              >
                <Award size={16} /> {cert}
              </span>
            ))}
      ...
      <section className="py-16 bg-gradient-to-br from-[#0056b3] via-[#004494] to-[#003366] mb-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            Ready to Study in UK from Nepal?
          </h2>
          <p className="text-blue-200 mb-6 text-lg">
            Start your UK student visa journey with Nepal&apos;s trusted
            education consultants. Our team has guided 1,500+ Nepali students
            through the UK visa process from Nepal—from university selection to
            visa approval.
          </p>
          <p className="text-blue-100 mb-8">
            From CAS preparation to document checks and Graduate Route
            advice—we&apos;ve supported over 1,500 Nepali students on their UK
            journey. Visit Tinkune, Baneshwor, Ghorahi, or Itahari, or reach us
            on WhatsApp for immediate support.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/consultation/"
              className="inline-flex items-center justify-center gap-2 bg-white text-[#001F3F] px-8 py-4 rounded-xl font-bold hover:bg-blue-50 transition-all shadow-lg"
            >
              Book Free Consultation
            </Link>
            <Link
              href="/contact/"
              className="inline-flex items-center justify-center gap-2 bg-blue-500 text-white px-8 py-4 rounded-xl font-bold hover:bg-blue-600 transition-all"
            >
              Apply Now
            </Link>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-xl font-bold hover:bg-[#128C7E] transition-all"
            >
              <Phone size={20} />
              WhatsApp Us
            </a>
          ...
          <p className="mt-6 text-blue-300 text-sm">
            <Link href="/study-abroad/can/" className="underline font-medium">
              Canada
            </Link>
            {" · "}
            <Link href="/study-abroad/usa/" className="underline font-medium">
              USA
            </Link>
            {" · "}
            <Link href="/study-abroad/aus/" className="underline font-medium">
              Australia
            </Link>
            {" · "}
            <Link
              href="/study-abroad/eur/germany/"
              className="underline font-medium"
            >
              Germany
            </Link>
            {" · "}
            <Link href="/scholarships/" className="underline font-medium">
              Scholarships
            </Link>
          </p>
      ...
      <section className="py-12 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/consultation/"
            className="inline-flex items-center px-6 py-3 bg-[#001F3F] text-white font-semibold rounded-xl hover:bg-[#003366] transition-colors"
          >
            Book Free Consultation
          </Link>
        </div>

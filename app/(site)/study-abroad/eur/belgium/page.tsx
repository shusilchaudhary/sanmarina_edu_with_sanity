      ...
      <section className="relative min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Study in Belgium from Nepal
            <br />
            <span className="text-blue-300">2026 – Cost, Visa & ARES Scholarship</span>
          </h1>
          <p className="text-xl text-blue-100 mb-4 max-w-2xl">
            Study in Belgium for international students: tuition €835–€8,000, study in Belgium in English at KU Leuven, Ghent, Brussels. Work 650 hrs/year. 12-month post-study.
          </p>

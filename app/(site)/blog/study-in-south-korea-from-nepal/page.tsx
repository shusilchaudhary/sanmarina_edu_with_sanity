...
export const metadata: Metadata = {
  title: 'Study in South Korea from Nepal 2026 — D-2 Visa, Costs, Scholarships & OPT Guide | San Marina',
  description: 'Complete 2026 guide: Study in South Korea from Nepal. D-2 Visa step-by-step, costs NPR 10–30 lakhs, GKS scholarship, D-10 Job Seeker Visa, top universities & courses for Nepali students.',
  ...
  openGraph: {
    title: 'Study in South Korea from Nepal 2026 — Complete Guide | San Marina',
    description: 'D-2 Visa, costs in NPR, GKS scholarship, D-10 Job Seeker Visa, top universities — complete South Korea study guide for Nepali students.',
...
const sections = [
  ...
  { id: 'visa', label: 'D-2 Visa Process' },
...
const faqData = [
  ...
  { q: 'What are the minimum requirements to study in USA from Nepal?', a: 'For undergraduate admission: completion of 10+2 / NEB / A-Levels, IELTS 6.0+ or TOEFL 61+, and a valid passport. For master\'s admission: a completed bachelor\'s degree with transcripts, IELTS 6.5+ or TOEFL 79+, and GRE/GMAT scores (where required). Financial proof is required for the D-2 Visa — typically covering first year\'s tuition plus living expenses.' },
  { q: 'Can I get a full scholarship to study in USA from Nepal?', a: 'Yes, full scholarships are available but competitive. The GKS Nepal Program provides full government funding for outstanding students. Many universities offer full tuition waivers to top international applicants. PhD programs typically provide full funding plus a living stipend. Graduate assistantships (RA/TA) cover tuition and provide monthly stipends at many research universities. Apply 8–12 months early for best chances.' },
  { q: 'How long does the F-1 US student visa process take from Nepal?', a: 'From receiving your Certificate of Admission to attending your visa interview, allow 4–6 weeks minimum. Visa appointment availability at the Korean Embassy Kathmandu can be limited during peak periods (April–July), so book as soon as you have your Certificate of Admission. Visa decisions are typically given on the interview day, with passport return within 5–10 business days if approved.' },
  ...
  { q: 'Which intake is best for Nepali students applying to Korean universities?', a: 'The Fall intake (August–September) is the primary intake with the most programs, scholarships, and available seats. Spring intake (January) is also available at many universities. Summer intake (May–June) is limited. Most Nepali students prefer Fall for maximum options and scholarship availability.' },
  ...
  { q: 'What is the GKS Scholarship for Nepali students?', a: 'The GKS Nepal Program is the US Government\'s flagship scholarship — covering full tuition, living expenses, health insurance, and return flights. It is available for 1-year Master\'s or PhD programmes at Korean universities. Requirements: Nepali citizenship, bachelor\'s degree, strong academic record, 2+ years work experience preferred. Applications open annually through the Korean Embassy Kathmandu. Highly competitive — roughly 10–15 awards per year for Nepal.' },
  { q: 'What documents are required for the F-1 US student visa?', a: 'Required documents: (1) Valid passport (6+ months validity), (2) Certificate of Admission form from SEVP-approved US university, (3) Processing I-901 fee receipt ($350), (4) DS-160 confirmation page with barcode, (5) MRV visa application fee receipt ($185, paid at Nabil Bank), (6) Bank statements/financial proof for first year costs, (7) Academic transcripts (SEE through latest degree), (8) IELTS/TOEFL score report, (9) University acceptance letter, (10) Evidence of ties to Nepal (property, family, employment prospects).' },
...
export default function KoreaBlogPage() {
  return (
    <main className="min-h-screen bg-[#F8F7F4]">
      ...
      <nav className="bg-white border-b border-gray-100 py-3 px-4" aria-label="Breadcrumb">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-sm text-gray-500 flex-wrap">
          ...
          <span>›</span>
          <span className="text-[#001F3F] font-medium">Study in South Korea from Nepal 2026</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-[1fr_340px] gap-10 items-start">
            ...
            <div className="pb-10">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-4">
                Study in <span className="text-yellow-300">South Korea</span> from Nepal 2026
              </h1>
              <p className="text-white/70 text-lg leading-relaxed mb-6 max-w-xl">
                Everything Nepali students need — D-2 Visa step-by-step, costs in NPR, GKS scholarship, D-10 Job Seeker Visa, top universities, courses with best career outcomes, and a 14-month application timeline.
              </p>

              <div className="flex flex-wrap gap-2 mb-6">
                {['🎓 5,000+ Universities','💵 From $6,000/yr (Language School)','🔬 Post-Study Work 36 Months','🏆 GKS Full Scholarship','🌍 H-1B Pathway','🎯 Fall & Spring Intakes'].map(b => (
        ...
        <div className="flex gap-8 items-start">
          ...
          <aside className="hidden lg:block w-64 shrink-0 sticky top-[57px]">
            ...
            <div className="bg-[#001F3F] rounded-2xl p-5 text-center">
              ...
              <p className="text-white/60 text-xs mb-4">D-2 Visa prep · SOP review · Uni selection · Mock interview</p>
          ...
          <div className="flex-1 min-w-0 space-y-10">
            ...
            <section id="keyfacts" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-700 to-blue-900 px-4 sm:px-6 py-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-white font-bold text-base sm:text-xl">Key Facts — Study in South Korea from Nepal 2026</h2>
                </div>
              </div>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ...
                        ['Processing Fee', '$350 (~NPR 47,000) — paid once on Certificate of Admission receipt'],
            ...
            <section id="why" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 sm:p-6">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { icon: '🏛️', title: 'World-Class Universities', desc: 'MIT, Stanford, Harvard, Caltech — 5,000+ accredited institutions. Many of the world\'s top 20 universities are Korean.' },
                    ...
                    { icon: '🎓', title: 'Scholarships & Aid', desc: 'GKS Nepal, university merit scholarships, graduate assistantships (RA/TA), and need-based aid can significantly cut costs.' },
            ...
            <section id="requirements" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 px-4 sm:px-6 py-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-white font-bold text-base sm:text-xl">Requirements to Study in South Korea from Nepal</h2>
                </div>
              </div>
              <div className="p-4 sm:p-6">
                  ...
                  <div className="bg-green-50 rounded-xl p-5">
                    ...
                    <div className="space-y-1.5">
                      {[
                        ...
                        'Certificate of Admission form from your SEVP-approved US university',
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ...
                        ['PTE Academic', 'Varies', 'Accepted at select Korean universities'],
            ...
            <section id="visa" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 sm:p-6">
                <div className="space-y-4 mb-6">
                  {[
                    ['Gain admission & receive your Certificate of Admission form', 'Apply to SEVP-approved Korean universities. Once accepted, the university issues your Certificate of Admission (Certificate of Eligibility). Apply to 5–10 universities to maximize options and scholarship chances.'],
                    ['Pay the Processing I-901 fee ($350 / ~NPR 47,000)', 'Pay the mandatory Processing fee at fmjfee.com using your Certificate of Admission number. This registers your student record in the US government\'s Processing system. Keep the payment receipt.'],
                    ['Complete the DS-160 online visa application', 'Fill in the DS-160 form at Korea Visa Portal. Ensure all names, dates, and addresses exactly match your passport and Certificate of Admission. Print the confirmation page with barcode for your interview.'],
                    ...
                    ['Schedule your visa interview at Korean Embassy Kathmandu', 'Book your D-2 Visa interview at the Korean Embassy, Maharajgunj, Kathmandu via ustraveldocs.com/np. Book 3–4 months before your program start date — appointments fill quickly in April–July.'],
                  ...
                  <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
                    <thead className="bg-[#001F3F] text-white">
                      <tr>
                        ...
                        <th className="text-left py-2.5 px-4 text-xs font-semibold">D-2 Visa</th>
            ...
            <section id="scholarships" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    { name: 'GKS Nepal Program', coverage: 'Fully funded — tuition + living expenses + health insurance + flights', eligibility: 'Nepali citizenship · Strong academic record · 2+ yrs work experience preferred', deadline: 'Annual — check Korean Embassy Kathmandu', color: 'border-yellow-400' },
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ...
                        ['4–6 months before', 'Receive Certificate of Admission; pay Processing; complete DS-160', 'Keep all receipts'],
                        ['3–4 months before', 'Book visa interview at Korean Embassy Kathmandu', 'Early booking recommended'],
              ...
              <div className="p-4 sm:p-6">
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { icon: '🤝', title: 'Nepali Community', desc: 'Most major Korean universities have Nepali Student Associations (NSA). Active communities in Texas, Ohio, California, New York, and Massachusetts. WhatsApp groups, cultural events, and Nepali food options in most large cities.' },
                    { icon: '📱', title: 'SIM & Banking', desc: 'Get a US SIM on arrival — T-Mobile, AT&T, or Verizon prepaid. Open a bank account at Chase, Bank of South Korea, or Wells Fargo (no SSN required initially with university letter). Build US credit history from month 1.' },
            ...
            <div className="bg-gradient-to-r from-[#001F3F] to-[#002d5a] rounded-2xl p-8 text-center">
              ...
              <p className="text-white/70 text-sm mb-6 max-w-lg mx-auto">SOP review · University shortlisting · D-2 Visa mock interview · Certificate of Admission tracking · Processing payment guidance. Free initial consultation for Nepali students.</p>
        ...
        '@graph': [
          {
            ...
            description: 'Complete guide for Nepali students on studying in the USA in 2026 — D-2 Visa, costs in NPR, GKS scholarship, Post-Study Work, top universities.',

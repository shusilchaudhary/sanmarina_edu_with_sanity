      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-6 lg:py-10 flex flex-col lg:flex-row gap-8 items-start">
        ...
        <div className="flex-1 min-w-0 space-y-10">
          ...
          <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
            ...
            '@graph': [
              { '@type': 'Article', headline: 'Study in Australia from Nepal 2026 — Visa, Cost, Universities & PR Guide', description: 'Complete 2026 guide for Nepali students on studying in Australia covering Assessment Level 3, costs in NPR, universities, scholarships, and PR pathways.', datePublished: '2026-05-17', author: { '@type': 'Organization', name: 'San Marina Education Consultancy' }, publisher: { '@type': 'Organization', name: 'San Marina Education Consultancy', url: 'https://www.sanmarina.edu.np' }, image: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=1280&q=80', mainEntityOfPage: 'https://www.sanmarina.edu.np/blog/study-in-australia-from-nepal-for-nepali-students/' },

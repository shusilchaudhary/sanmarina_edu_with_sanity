...
export const metadata: Metadata = {
  title: 'Study in Japan from Nepal 2026 — Student Visa, Costs, Scholarships & OPT Guide | San Marina',
  description: 'Complete 2026 guide: Study in Japan from Nepal. Student Visa step-by-step, costs NPR 11–51 lakhs, MEXT scholarship, 28 hours/week part-time work, top universities & courses for Nepali students.',
  ...
  openGraph: {
    ...
    description: 'Student Visa, costs in NPR, MEXT scholarship, 28 hours/week part-time work, top universities — complete Japan study guide for Nepali students.',
...
const faqData = [
  { q: 'How much does it cost to study in USA from Nepal in total?', a: 'Total annual costs range from NPR 25 lakh to over NPR 1.1 crore, depending on university type and location. Language schools are the most affordable at $6,000–$18,000/year in tuition. Public universities cost $10,000–$35,000/year; private universities $25,000–$65,000/year. Add living costs of $10,000–$25,000 annually. Scholarships and graduate assistantships can significantly reduce these figures.' },
  ...
  { q: 'Can I get a full scholarship to study in USA from Nepal?', a: 'Yes, full scholarships are available but competitive. The MEXT Nepal Program provides full government funding for outstanding students. Many universities offer full tuition waivers to top international applicants. PhD programs typically provide full funding plus a living stipend. Graduate assistantships (RA/TA) cover tuition and provide monthly stipends at many research universities. Apply 8–12 months early for best chances.' },
  { q: 'How long does the F-1 US student visa process take from Nepal?', a: 'From receiving your COE to attending your visa interview, allow 4–6 weeks minimum. Visa appointment availability at the VFS Global Kathmandu can be limited during peak periods (April–July), so book as soon as you have your COE. Visa decisions are typically given on the interview day, with passport return within 5–10 business days if approved.' },
  ...
  { q: 'Which intake is best for Nepali students applying to Japanese universities?', a: 'The Fall intake (August–September) is the primary intake with the most programs, scholarships, and available seats. Spring intake (January) is also available at many universities. Summer intake (May–June) is limited. Most Nepali students prefer Fall for maximum options and scholarship availability.' },
  ...
  { q: 'What is the MEXT Scholarship for Nepali students?', a: 'The MEXT Nepal Program is the US Government\'s flagship scholarship — covering full tuition, living expenses, health insurance, and return flights. It is available for 1-year Master\'s or PhD programmes at Japanese universities. Requirements: Nepali citizenship, bachelor\'s degree, strong academic record, 2+ years work experience preferred. Applications open annually through the VFS Global Kathmandu. Highly competitive — roughly 10–15 awards per year for Nepal.' },
  { q: 'What documents are required for the F-1 US student visa?', a: 'Required documents: (1) Valid passport (6+ months validity), (2) COE form from SEVP-approved US university, (3) Processing I-901 fee receipt ($350), (4) DS-160 confirmation page with barcode, (5) MRV visa application fee receipt ($185, paid at VFS Global), (6) Bank statements/financial proof for first year costs, (7) Academic transcripts (SEE through latest degree), (8) IELTS/TOEFL score report, (9) University acceptance letter, (10) Evidence of ties to Nepal (property, family, employment prospects).' },
    ...
    <main className="min-h-screen bg-[#F8F7F4]">
      ...
      <nav className="bg-white border-b border-gray-100 py-3 px-4" aria-label="Breadcrumb">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-sm text-gray-500 flex-wrap">
          ...
          <span>›</span>
          <span className="text-[#001F3F] font-medium">Study in Japan from Nepal 2026</span>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-[1fr_340px] gap-10 items-start">
            ...
            <div className="pb-10">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-4">
                Study in <span className="text-yellow-300">Japan</span> from Nepal 2026
              </h1>
              <p className="text-white/70 text-lg leading-relaxed mb-6 max-w-xl">
                Everything Nepali students need — Student Visa step-by-step, costs in NPR, MEXT scholarship, 28 hours/week part-time work, top universities, courses with best career outcomes, and a 14-month application timeline.
              </p>

              <div className="flex flex-wrap gap-2 mb-6">
                {['🎓 5,000+ Universities','💵 From $6,000/yr (Language School)','🔬 Post-Study Work 36 Months','🏆 MEXT Full Scholarship','🌍 H-1B Pathway','🎯 Fall & Spring Intakes'].map(b => (
            ...
            <div className="hidden lg:block bg-white rounded-t-2xl overflow-hidden shadow-2xl self-end">
              ...
              <div className="divide-y divide-gray-100">
                {[
                  ['Min. Tuition', '$6,000/yr Language School (NPR ~8L)'],
                  ['Visa Type', 'F-1 Student Visa'],
                  ['Processing Fee', '$350 (~NPR 47,000) — one time'],
                  ['MRV Visa Fee', '$185 (~NPR 25,000) — paid at VFS Global'],
      ...
      <div className="lg:hidden bg-[#001F3F] px-4 pb-4">
        <div className="bg-white/10 border border-white/20 rounded-2xl overflow-hidden">
          ...
          <div className="grid grid-cols-2 divide-x divide-white/10">
            {[
              ['Min. Tuition', '$6,000/yr Language School'],
              ['Visa Type', 'F-1 Student Visa'],
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-10">
            ...
            <section id="keyfacts" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-700 to-blue-900 px-4 sm:px-6 py-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-white font-bold text-base sm:text-xl">Key Facts — Study in Japan from Nepal 2026</h2>
                </div>
              </div>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ...
                        ['Processing Fee', '$350 (~NPR 47,000) — paid once on COE receipt'],
                        ['MRV Visa Fee', '$185 (~NPR 25,000) — paid at VFS Global Nepal'],
            ...
            <section id="why" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 sm:p-6">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { icon: '🏛️', title: 'World-Class Universities', desc: 'MIT, Stanford, Harvard, Caltech — 5,000+ accredited institutions. Many of the world\'s top 20 universities are Japanese.' },
                    ...
                    { icon: '📚', title: 'Flexible Academic Programs', desc: 'Choose your major, add minors, take electives. Double majors and language school transfers are standard practice.' },
                    ...
                    { icon: '🎓', title: 'Scholarships & Aid', desc: 'MEXT Nepal, university merit scholarships, graduate assistantships (RA/TA), and need-based aid can significantly cut costs.' },
            ...
            <section id="requirements" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 px-4 sm:px-6 py-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-white font-bold text-base sm:text-xl">Requirements to Study in Japan from Nepal</h2>
                </div>
              </div>
              <div className="p-4 sm:p-6">
                  ...
                  <div className="bg-green-50 rounded-xl p-5">
                    ...
                    <div className="space-y-1.5">
                      {[
                        ...
                        'COE form from your SEVP-approved US university',
                        'Processing I-901 fee payment receipt ($350)',
                        'Completed DS-160 online visa application form',
                        'MRV visa fee receipt ($185 — VFS Global Nepal)',
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ...
                        ['PTE Academic', 'Varies', 'Accepted at select Japanese universities'],
            ...
            <section id="costs" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 sm:p-6">
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                  <p className="text-blue-800 font-semibold text-sm">💡 Smart Strategy: Language School Pathway</p>
                  <p className="text-blue-700 text-xs mt-1">Start at a language school ($6,000–$18,000/year), transfer to a prestigious 4-year university after 2 years. Save NPR 20–40 lakhs while still graduating from a well-known university.</p>
                </div>
                <div className="overflow-x-auto mb-6">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ['Language School', "Associate's Degree", '$6,000–$18,000', 'NPR 8–24 lakh'],
            ...
            <section id="visa" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 sm:p-6">
                <div className="space-y-4 mb-6">
                  {[
                    ['Gain admission & receive your COE form', 'Apply to SEVP-approved Japanese universities. Once accepted, the university issues your COE (Certificate of Eligibility). Apply to 5–10 universities to maximize options and scholarship chances.'],
                    ['Pay the Processing I-901 fee ($350 / ~NPR 47,000)', 'Pay the mandatory Processing fee at fmjfee.com using your COE number. This registers your student record in the US government\'s Processing system. Keep the payment receipt.'],
                    ['Complete the DS-160 online visa application', 'Fill in the DS-160 form at VFS Global. Ensure all names, dates, and addresses exactly match your passport and COE. Print the confirmation page with barcode for your interview.'],
                    ['Pay the MRV visa fee ($185 / ~NPR 25,000)', 'Pay the non-refundable MRV fee at a designated VFS Global branch in Nepal. Retain the bank receipt — required to schedule your visa interview.'],
                    ['Schedule your visa interview at VFS Global Kathmandu', 'Book your Student Visa interview at the Japanese Embassy, Maharajgunj, Kathmandu via ustraveldocs.com/np. Book 3–4 months before your program start date — appointments fill quickly in April–July.'],
            ...
            <section id="scholarships" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    { name: 'MEXT Nepal Program', coverage: 'Fully funded — tuition + living expenses + health insurance + flights', eligibility: 'Nepali citizenship · Strong academic record · 2+ yrs work experience preferred', deadline: 'Annual — check VFS Global Kathmandu', color: 'border-yellow-400' },
              ...
              <div className="p-4 sm:p-6">
                <div className="grid sm:grid-cols-3 gap-4 mb-6">
                  {[
                    ...
                    { intake: 'Summer Intake', months: 'May–June', status: '⚠️ LIMITED', desc: 'Limited availability, mainly for short courses and language schools.' },
                  ].map(c => (
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ...
                        ['4–6 months before', 'Receive COE; pay Processing; complete DS-160', 'Keep all receipts'],
                        ['3–4 months before', 'Book visa interview at VFS Global Kathmandu', 'Early booking recommended'],
              ...
              <div className="p-4 sm:p-6">
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { icon: '🤝', title: 'Nepali Community', desc: 'Most major Japanese universities have Nepali Student Associations (NSA). Active communities in Texas, Ohio, California, New York, and Massachusetts. WhatsApp groups, cultural events, and Nepali food options in most large cities.' },
                    { icon: '📱', title: 'SIM & Banking', desc: 'Get a US SIM on arrival — T-Mobile, AT&T, or Verizon prepaid. Open a bank account at Chase, Bank of Japan, or Wells Fargo (no SSN required initially with university letter). Build US credit history from month 1.' },
            ...
            <div className="bg-gradient-to-r from-[#001F3F] to-[#002d5a] rounded-2xl p-8 text-center">
              ...
              <p className="text-white/70 text-sm mb-6 max-w-lg mx-auto">SOP review · University shortlisting · Student Visa mock interview · COE tracking · Processing payment guidance. Free initial consultation for Nepali students.</p>
        ...
        '@graph': [
          {
            ...
            description: 'Complete guide for Nepali students on studying in the USA in 2026 — Student Visa, costs in NPR, MEXT scholarship, Post-Study Work, top universities.',

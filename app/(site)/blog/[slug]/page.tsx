    ...
    <main className="min-h-screen bg-gray-50 pb-20">
      ...
      <article className="max-w-3xl mx-auto px-4 pt-16">
        <div className="prose prose-lg max-w-none
          ...
          prose-strong:text-[#001F3F] prose-strong:font-semibold
          prose-ul:text-gray-700 prose-ol:text-gray-700
          prose-li:my-1.5
          prose-table:w-full prose-table:text-sm
          prose-th:bg-[#001F3F] prose-th:text-white prose-th:px-4 prose-th:py-3 prose-th:text-left
          prose-td:px-4 prose-td:py-3 prose-td:border-b prose-td:border-gray-100
          prose-blockquote:border-blue-500 prose-blockquote:bg-blue-50 prose-blockquote:py-2 prose-blockquote:rounded-r-lg

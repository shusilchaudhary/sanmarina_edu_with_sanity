...
export const metadata: Metadata = {
  title: 'Best Education Consultancy in Kathmandu | 2026 Guide',
  description: 'Best Education Consultancy in Kathmandu 2026: MEXT, JLPT, tuition, COE. Is it good to study in Kathmandu? Can you study without Kathmanduese? Gap policy. Study Abroad Consultancy in Kathmandu consultancy in Nepal. Free consultation.',
  ...
  alternates: {
    canonical: 'https://www.sanmarina.edu.np/kathmandu/',
  },
  openGraph: {
    type: 'article',
    url: 'https://www.sanmarina.edu.np/kathmandu/',
    title: 'Best Education Consultancy in Kathmandu – 2026 Complete Guide',
    description: 'Complete 2026 guide for Nepali students: study in Kathmandu, MEXT, JLPT, SGU programs. Free consultation in Kathmandu.',
  ...
  twitter: {
    ...
    title: 'Best Education Consultancy in Kathmandu – 2026 Complete Guide',
    description: 'Complete 2026 guide for Nepali students: study in Kathmandu, MEXT, JLPT, SGU programs.',
  },
};
...
const japanData = {
  ...
  popularCourses: [
    ...
    { name: 'Kathmanduese Language', universities: 'Language schools nationwide', intake: 'Jan, Apr, Jul, Oct' },
  ],
  costBreakdown: {
  ...
  visaSteps: [
    'Receive admission from Kathmanduese university or language school',
    'Institution applies for Certificate of Eligibility (COE) in Kathmandu',
    ...
    'Enter Kathmandu and complete residence registration',
  ],
  requirements: [
    'Admission letter from Kathmanduese institution',
    'Certificate of Eligibility (COE)',
    'Valid passport (6+ months)',
    'Financial proof: ¥1,500,000+ for first year (approx. NPR 20 lakhs)',
    'Kathmanduese: JLPT N5 for language schools; N2 for universities (or EJU)',
  ...
  faqs: [
    {
      question: 'Is it good to study in Kathmandu?',
      answer: 'Yes. Kathmandu offers world-ranked universities (Kathmandu, Kyoto, Osaka in QS Top 100), MEXT full scholarships, cutting-edge research in tech and engineering, and safe cities. Study Abroad Consultancy in Kathmandu for international students means SGU English programs, JLPT pathways, and 28 hrs/week part-time work. Over 5,000 Nepali students study in Kathmandu.',
    },
    {
      question: 'Best Education Consultancy in Kathmandu – what are the requirements?',
      answer: 'Best Education Consultancy in Kathmandu requires: admission from Kathmanduese institution, Certificate of Eligibility (COE), financial proof ¥1,500,000+ (NPR ~20L), JLPT N5 for language schools or N2 for universities (or EJU). SGU English programs need IELTS 6.0+. Apply via VFS Global Kathmandu (Embassy does not accept direct applications). Processing 5–10 working days.',
    },
    {
      question: 'Can I study in Kathmandu without knowing Kathmanduese?',
      answer: 'Yes. SGU (Super Global Universities) and G30 programs offer 100+ English-taught degree programs. However, daily life, part-time jobs, and networking improve with Kathmanduese. JLPT N3–N2 opens many more options. Language schools offer 1–2 year preparatory courses.',
    },
    {
      question: 'How much gap is accepted for study in Kathmandu?',
      answer: 'How much gap is accepted for study in Kathmandu: typically 1–2 years if explained. Gaps of 3+ years need work experience or recent courses. MEXT and some universities may be stricter. Provide a clear gap explanation letter with dates and activities.',
    },
    {
      question: 'What are the disadvantages of studying in Kathmandu?',
      answer: 'Disadvantages of studying in Kathmandu: language barrier for non-SGU students, high cost in Kathmandu, earthquake risk, rigid work culture. However, MEXT covers costs for scholarship recipients, and Osaka/Kyoto offer more affordable living. We present both sides so you decide.',
    },
    {
      question: 'What is the MEXT scholarship for Nepali students?',
      answer: 'MEXT (Ministry of Education, Kathmandu) offers full scholarships: tuition waiver, airfare, monthly stipend ¥117,000–¥242,000 depending on level. Undergrad: ¥242,000/mo; Research (master\'s/PhD): ¥143,000–145,000/mo. Apply via Kathmanduese Embassy Kathmandu. Highly competitive.',
    },
    {
      question: 'Study Abroad Consultancy in Kathmandu for international students – English programs?',
      answer: 'Study Abroad Consultancy in Kathmandu for international students: SGU/G30 offers 100+ English-taught programs at Kathmandu, Kyoto, Osaka, Waseda, Keio, etc. No Kathmanduese required for admission. IELTS 6.0+ typical. Fields: Engineering, Business, IT, Life Sciences.',
    },
    {
      question: 'Study Abroad Consultancy in Kathmandu consultancy in Nepal – why choose San Marina?',
      answer: 'Study Abroad Consultancy in Kathmandu consultancy in Nepal: San Marina guides MEXT applications, JLPT prep, COE process, and university selection. Offices in Kathmandu, Dang, Itahari. QEAC certified. Free first consultation for students from across Nepal.',
    },
    {
      question: 'Business studies in Kathmandu – which universities?',
      answer: 'Business studies in Kathmandu: Waseda (WBS), Keio (KBS), Hitotsubashi, University of Kathmandu. Many offer English MBA and bachelor\'s. Tuition ¥800,000–1,500,000/year. Strong connections to Kathmanduese corporates. MEXT covers tuition for scholarship recipients.',
    },
    {
      question: 'How much does it cost to study in Kathmandu from Nepal in 2026?',
      answer: 'Cost to study in Kathmandu from Nepal: National universities ¥818,000 first year (NPR ~11L); private ¥1.3–3.8M (NPR 17–51L). Living Kathmandu ¥120,000–150,000/month. Total first year ¥2–4M (NPR 27–54L). 1 JPY ≈ 1.35 NPR (Feb 2026). MEXT covers most costs for recipients.',
    },
  ],
};

const comparisonData = [
  { country: 'Kathmandu', countrySlug: null, tuition: '¥535,800–1.5M', living: '¥80,000–150,000/mo', work: '28 hrs/week', psw: '6 mo–5 yrs', visaTime: '5–10 days' },
...
export default function KathmanduStudyPage() {
  const visaStepsWithText = [
    { name: 'Receive admission from Kathmanduese university or language school', text: 'Obtain admission letter from Kathmanduese institution.' },
    { name: 'Institution applies for Certificate of Eligibility (COE) in Kathmandu', text: 'Your institution applies for COE on your behalf.' },
    ...
    { name: 'Enter Kathmandu and complete residence registration', text: 'Register residence after arrival in Kathmandu.' },
  ];
  ...
  const jsonLd = {
    ...
    '@graph': [
      {
        '@type': 'Article',
        headline: 'Best Education Consultancy in Kathmandu 2026 – Complete Guide',
      ...
      },
      {
        ...
        description: 'Best education consultancy in Nepal for Kathmandu study abroad',
        url: 'https://www.sanmarina.edu.np',
        knowsAbout: ['Best Education Consultancy in Kathmandu', 'MEXT scholarship', 'JLPT', 'COE', 'SGU', 'Certificate of Eligibility'],
      },
      {
        '@type': 'FAQPage',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Study Abroad Consultancy in Kathmandu', item: 'https://www.sanmarina.edu.np/kathmandu/' },
        ],
      },
      {
        '@type': 'HowTo',
        name: 'How to Apply for Kathmandu Student Visa from Nepal',
        description: 'Step-by-step guide: receive admission, obtain COE, apply via VFS Global Kathmandu, receive visa. Based on 2026 Kathmanduese immigration procedures.',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image src={japanData.heroImage} alt="Nepali students in Kathmandu, Kathmandu – study abroad destination 2026 – San Marina Education Consultancy" fill className="object-cover" priority />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <nav className="text-sm text-blue-200 mb-6">
            ...
            <ChevronRight className="inline mx-2" size={14} />
            <span className="text-white">Study Abroad Consultancy in Kathmandu</span>
          </nav>
          <p className="text-xs text-blue-200 mb-2">Last Updated: February 2026</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Best Education Consultancy in Kathmandu<br />
          ...
          <p className="text-lg text-white/80 mb-8">
            Applicants from Kathmandu, Dang, Itahari, and across Nepal—our <strong>study in Kathmandu consultancy in Nepal</strong> handles MEXT applications, JLPT prep, and COE guidance. Free first consultation.
          </p>
      ...
      <section className="py-6 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-xl font-bold text-[#001F3F] mb-4 text-center">Best Education Consultancy in Kathmandu – Key Facts 2026</h2>
          ...
          <p className="text-xs text-gray-500 mt-3 text-center">Source: MEXT, JASSO, studyinjapan.go.jp. Verify at <a href="https://www.studyinjapan.go.jp/en/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">studyinjapan.go.jp</a>, <a href="https://www.np.emb-japan.go.jp" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">Kathmanduese Embassy Nepal</a>.</p>
        </div>
      </section>
      ...
      {/* Why Study Abroad Consultancy in Kathmandu in 2026 */}
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Why Study Abroad Consultancy in Kathmandu in 2026?</h2>
        <p className="text-lg text-gray-700 mb-6 font-medium">
          <strong>In brief:</strong> <strong>Study Abroad Consultancy in Kathmandu</strong> means access to University of Kathmandu (QS #28), Kyoto, Osaka—plus MEXT full scholarships, SGU English programs, and 28 hrs/week part-time work. Over 5,000 Nepali students already study in Kathmandu. Compare with <Link href="/study-abroad/usa/" className="text-blue-600 hover:underline">USA</Link>, <Link href="/study-abroad/uk/" className="text-blue-600 hover:underline">UK</Link>, or <Link href="/study-abroad/can/" className="text-blue-600 hover:underline">Canada</Link> to find your fit.
        </p>
        <div className="prose prose-lg max-w-none text-gray-700">
          <p className="mb-4">
            Kathmandu combines cutting-edge research with tradition. The government&apos;s <strong>MEXT scholarship</strong> covers tuition, airfare, and monthly stipend—no repayment. <strong>Study Abroad Consultancy in Kathmandu for international students</strong> includes 100+ English-taught degrees under the SGU initiative, so you can earn a degree without fluent Kathmanduese. Tech, engineering, and business programs are among the strongest globally.
          </p>
          <p className="mb-4">
            For Nepali applicants, the journey starts at the Kathmanduese Embassy in Kathmandu. COE (Certificate of Eligibility) processing takes 2–3 months; visa issuance 5–10 working days. San Marina supports students from Kathmandu, Dang, and Itahari with MEXT prep, JLPT coaching, and university shortlisting.
          </p>
        </div>
      </section>

      {/* Is it Good to Study Abroad Consultancy in Kathmandu */}
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Is it Good to Study Abroad Consultancy in Kathmandu?</h2>
          <p className="text-lg text-gray-700 mb-6 font-medium">
            <strong>Quick answer:</strong> Yes. <strong>Is it good to study in Kathmandu?</strong> Kathmandu offers top-ranked universities, full MEXT funding, safe cities, strong job prospects in tech and manufacturing, and unique cultural immersion. Trade-offs: language learning curve for Kathmanduese-taught programs, high cost in Kathmandu. Many students choose Osaka or Kyoto for affordability.
          </p>
      ...
      {/* Top Universities in Kathmandu */}
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-8 text-center">Top Universities in Kathmandu (2026)</h2>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-8">
            <strong>In brief:</strong> <strong>Business studies in Kathmandu</strong> thrive at Waseda, Keio, Hitotsubashi. IT and Engineering dominate at Kathmandu Tech, Kyoto, Osaka. All offer English-taught options. Language schools provide 1–2 year JLPT prep for Kathmanduese-medium programs.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-6">
            <strong>In brief:</strong> <strong>MEXT</strong> (Ministry of Education, Kathmandu): full tuition waiver + airfare + monthly stipend. Undergrad ¥242,000/mo; Research (master&apos;s/PhD) ¥143,000–145,000/mo. Apply via Kathmanduese Embassy Kathmandu (recommendation route). <a href="https://www.studyinjapan.go.jp/en/planning/scholarship/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">studyinjapan.go.jp</a>. <Link href="/scholarships/" className="text-blue-600 hover:underline">See all scholarships</Link>.
          </p>
      ...
      {/* Can You Study Without Kathmanduese */}
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Can You Study Abroad Consultancy in Kathmandu Without Knowing Kathmanduese?</h2>
        <p className="text-lg text-gray-700 mb-6 font-medium">
          <strong>Quick answer:</strong> <strong>Can I study in Kathmandu without knowing Kathmanduese?</strong> Yes. SGU (Super Global Universities) and G30 offer 100+ English-taught bachelor&apos;s and master&apos;s programs. Kathmandu, Kyoto, Osaka, Waseda, Keio—all have English options. IELTS 6.0+ typically required.
        </p>
        <p className="text-gray-700 mb-4">
          That said, daily life, part-time work, and networking improve dramatically with Kathmanduese. JLPT N3 opens convenience-store and restaurant jobs; N2 unlocks internships. Many students do 1–2 years at a language school first, then enter a Kathmanduese-taught degree. We advise choosing based on your timeline and career goals.
        </p>
      </section>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-6">How Much Gap is Accepted for Study Abroad Consultancy in Kathmandu?</h2>
          <p className="text-lg text-gray-700 mb-4">
            <strong>In brief:</strong> <strong>How much gap is accepted for study in Kathmandu?</strong> Typically 1–2 years if you provide a clear explanation. Gaps of 3+ years may need work experience or recent courses to show continuity. MEXT and top universities can be stricter—check each institution.
          </p>
          <p className="text-gray-700">
            Write a gap explanation letter with dates and activities. Part-time work, volunteering, or short courses help. San Marina helps applicants frame gaps effectively for Kathmanduese universities and MEXT selection.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-700 mb-8 max-w-2xl mx-auto">
            <strong>In brief:</strong> Get admission → institution applies for COE in Kathmandu → receive COE (2–3 months) → apply via VFS Global Kathmandu → visa in 5–10 working days. Embassy does not accept direct applications. Based on 2026 Kathmanduese immigration procedures.
          </p>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Intakes in Kathmandu</h2>
      ...
      {/* Disadvantages */}
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Disadvantages of Studying in Kathmandu</h2>
        <p className="text-gray-700 mb-4">
          <strong>In brief:</strong> <strong>Disadvantages of studying in Kathmandu</strong> include: language barrier for non-SGU students, high living cost in Kathmandu (¥120,000+ /month), earthquake risk, rigid corporate culture, and limited English in daily life outside big cities.
        </p>
        <p className="text-gray-700">
      ...
      {/* Cities */}
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-8 text-center">Top Kathmanduese Cities for Nepali Students</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-8 text-center">Kathmandu vs USA vs UK vs Canada – 2026</h2>
          <div className="overflow-x-auto">
      ...
      <section className="py-16 bg-white" id="faqs">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-2">Study Abroad Consultancy in Kathmandu FAQs</h2>
          <p className="text-gray-600 mb-8">Common questions about study in Kathmandu from Nepal in 2026</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-4 text-center">Why Choose Our Study Abroad Consultancy in Kathmandu Consultancy in Nepal?</h2>
          <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
            San Marina is a leading <strong>study in Kathmandu consultancy in Nepal</strong>. We guide MEXT applications, JLPT preparation, COE process, and university selection. Offices in Kathmandu, Dang, and Itahari. <Link href="/about/" className="text-blue-600 hover:underline">QEAC certified</Link>.
          </p>
      ...
      <section className="py-16 bg-gradient-to-br from-[#0056b3] via-[#004494] to-[#003366] mb-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Best Education Consultancy in Kathmandu?</h2>

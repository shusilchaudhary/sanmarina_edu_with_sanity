    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Online via the form on this page, or visit San Marina branches in Kathmandu (Tinkune, Baneshwor), Dang, or Itahari. Call 015922004.',
          },
        },
      ],
    },
              ...
              <div className="mt-10 space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Yes. Visit our <Link href="/contact/" className="text-blue-600 font-semibold hover:underline">4 branches</Link> in Kathmandu, Dang, or Itahari. Call 015922004.</p>
                  </div>
                </div>
              </div>
            </div>

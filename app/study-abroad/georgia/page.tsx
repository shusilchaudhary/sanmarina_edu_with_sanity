...
export default function GeorgiaStudyPage() {
  const jsonLd = {
    ...
    '@graph': [
      {
        '@type': 'Article',
        '@id': 'https://www.sanmarina.edu.np/study-abroad/georgia/#article',
        ...
        mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.sanmarina.edu.np/study-abroad/georgia/' },
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: 'Georgia', item: 'https://www.sanmarina.edu.np/study-abroad/georgia/' },
        ],
      },
      {
        '@type': 'Organization',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 max-w-4xl mx-auto px-4">
        ...
        <p className="text-lg text-gray-700 mb-4 font-medium">
          <strong>Quick answer:</strong> Study in Georgia offers affordable tuition, low living costs, no IELTS at most universities, fast visa (10–30 days), and WHO/UNESCO-recognized degrees. Tbilisi, Batumi. Compare with <Link href="/study-abroad/romania/" className="text-blue-600 hover:underline">Romania</Link>, <Link href="/study-abroad/eur/cyprus/" className="text-blue-600 hover:underline">Cyprus</Link>.
        </p>
        <p className="text-gray-700 mb-4">
          Study in Georgia for international students attracts those seeking quality education at lower cost. Nepali students from Kathmandu, Lalitpur, Pokhara choose Georgia for medicine, business, IT, and tourism. Gateway between Europe and Asia; hospitable culture; safe environment. Part of <Link href="/study-abroad/eur/" className="text-blue-600 hover:underline">Study in Europe</Link>—compare with <Link href="/study-abroad/romania/" className="text-blue-600 hover:underline">Romania</Link>, <Link href="/study-abroad/hungary/" className="text-blue-600 hover:underline">Hungary</Link>, and <Link href="/study-abroad/eur/cyprus/" className="text-blue-600 hover:underline">Cyprus</Link> for similar affordability.
        </p>
      </section>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-6 max-w-2xl mx-auto">
            Both affordable for Nepali students. Georgia: no IELTS (most), visa via India. Romania: embassy/Kathmandu, MBBS, pilot. Compare with <Link href="/study-abroad/romania/" className="text-blue-600 hover:underline">Romania</Link>.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-xl shadow-sm">
              <thead>

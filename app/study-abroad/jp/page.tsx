...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.sanmarina.edu.np/study-abroad/jp/',
  },
  openGraph: {
    type: 'article',
...
const japanData = {
  ...
  universities: [
    { name: 'University of Tokyo', rank: 'QS #28', location: 'Tokyo', highlight: 'Research & Engineering' },
    ...
    { name: 'Tokyo Institute of Technology', rank: 'QS #91', location: 'Tokyo', highlight: 'STEM & Innovation' },
  ...
  popularCourses: [
    ...
    { name: 'IT & Engineering', universities: 'Tokyo Tech, Kyoto, Osaka', intake: 'April, Oct' },
    { name: 'Japanese Language', universities: 'Language schools nationwide', intake: 'Jan, Apr, Jul, Oct' },
  ],
  costBreakdown: {
    ...
    livingTokyo: { yen: 120000, period: 'per month', npr: 162000 },
  ...
  visaSteps: [
    'Receive admission from Japanese university or language school',
    'Institution applies for Certificate of Eligibility (COE) in Japan',
  ...
  requirements: [
    ...
    'Japanese: JLPT N5 for language schools; N2 for universities (or EJU)',
  ...
  cities: [
    { name: 'Tokyo', highlight: 'Tech & Business', students: '2,000+ Nepali students', livingCost: '¥120,000–150,000/month' },
  ...
  faqs: [
    {
      question: 'Is it good to study in Japan?',
      answer: 'Yes. Japan offers world-ranked universities (Tokyo, Kyoto, Osaka in QS Top 100), MEXT full scholarships, cutting-edge research in tech and engineering, and safe cities. Study in Japan for international students means SGU English programs, JLPT pathways, and 28 hrs/week part-time work. Over 5,000 Nepali students study in Japan.',
    },
    {
      question: 'Study in Japan from Nepal – what are the requirements?',
      answer: 'Study in Japan from Nepal requires: admission from Japanese institution, Certificate of Eligibility (COE), financial proof ¥1,500,000+ (NPR ~20L), JLPT N5 for language schools or N2 for universities (or EJU). SGU English programs need IELTS 6.0+. Apply via VFS Global Kathmandu (Embassy does not accept direct applications). Processing 5–10 working days.',
    },
    {
      question: 'Can I study in Japan without knowing Japanese?',
      answer: 'Yes. SGU (Super Global Universities) and G30 programs offer 100+ English-taught degree programs. However, daily life, part-time jobs, and networking improve with Japanese. JLPT N3–N2 opens many more options. Language schools offer 1–2 year preparatory courses.',
    },
    {
      question: 'How much gap is accepted for study in Japan?',
      answer: 'How much gap is accepted for study in Japan: typically 1–2 years if explained. Gaps of 3+ years need work experience or recent courses. MEXT and some universities may be stricter. Provide a clear gap explanation letter with dates and activities.',
    },
    {
      question: 'What are the disadvantages of studying in Japan?',
      answer: 'Disadvantages of studying in Japan: language barrier for non-SGU students, high cost in Tokyo, earthquake risk, rigid work culture. However, MEXT covers costs for scholarship recipients, and Osaka/Kyoto offer more affordable living. We present both sides so you decide.',
    },
    {
      question: 'What is the MEXT scholarship for Nepali students?',
      answer: 'MEXT (Ministry of Education, Japan) offers full scholarships: tuition waiver, airfare, monthly stipend ¥117,000–¥242,000 depending on level. Undergrad: ¥242,000/mo; Research (master\'s/PhD): ¥143,000–145,000/mo. Apply via Japanese Embassy Kathmandu. Highly competitive.',
    },
    {
      question: 'Study in Japan for international students – English programs?',
      answer: 'Study in Japan for international students: SGU/G30 offers 100+ English-taught programs at Tokyo, Kyoto, Osaka, Waseda, Keio, etc. No Japanese required for admission. IELTS 6.0+ typical. Fields: Engineering, Business, IT, Life Sciences.',
    },
    {
      question: 'Study in Japan consultancy in Nepal – why choose San Marina?',
      answer: 'Study in Japan consultancy in Nepal: San Marina guides MEXT applications, JLPT prep, COE process, and university selection. Offices in Kathmandu, Dang, Itahari. QEAC certified. Free first consultation for students from across Nepal.',
    },
    {
      question: 'Business studies in Japan – which universities?',
...
const comparisonData = [
  { country: 'Japan', countrySlug: null, tuition: '¥535,800–1.5M', living: '¥80,000–150,000/mo', work: '28 hrs/week', psw: '6 mo–5 yrs', visaTime: '5–10 days' },
...
export default function JapanStudyPage() {
  const visaStepsWithText = [
    { name: 'Receive admission from Japanese university or language school', text: 'Obtain admission letter from Japanese institution.' },
    { name: 'Institution applies for Certificate of Eligibility (COE) in Japan', text: 'Your institution applies for COE on your behalf.' },
    ...
    { name: 'Enter Japan and complete residence registration', text: 'Register residence after arrival in Japan.' },
  ];
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: 'Best education consultancy in Nepal for Japan study abroad',
        url: 'https://www.sanmarina.edu.np',
        knowsAbout: ['Study in Japan from Nepal', 'MEXT scholarship', 'JLPT', 'COE', 'SGU', 'Certificate of Eligibility'],
      },
      {
        '@type': 'FAQPage',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Study in Japan', item: 'https://www.sanmarina.edu.np/study-abroad/jp/' },
        ],
      },
      {
        '@type': 'HowTo',
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Study in Japan from Nepal<br />
            <span className="text-blue-300">2026 Complete Guide</span>
          </h1>
          <p className="text-xl text-blue-100 mb-4 max-w-2xl">
            From Kathmandu to Tokyo—MEXT scholarships, SGU English programs, and 800+ universities. Based on official 2026 MEXT and JASSO data.
          </p>
          <p className="text-lg text-white/80 mb-8">
            Applicants from Kathmandu, Dang, Itahari, and across Nepal—our <strong>study in Japan consultancy in Nepal</strong> handles MEXT applications, JLPT prep, and COE guidance. Free first consultation.
          </p>
      ...
      <section className="py-6 bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-white rounded-xl shadow-sm text-sm">
              <tbody>
                ...
                <tr className="border-b border-gray-100"><td className="p-3 font-semibold text-[#001F3F]">Tokyo living</td><td className="p-3">¥120,000–150,000/month</td></tr>
          ...
          <p className="text-xs text-gray-500 mt-3 text-center">Source: MEXT, JASSO, studyinjapan.go.jp. Verify at <a href="https://www.studyinjapan.go.jp/en/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">studyinjapan.go.jp</a>, <a href="https://www.np.emb-japan.go.jp" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">Japanese Embassy Nepal</a>.</p>
        </div>
      </section>
      ...
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          <p className="mb-4">
            Japan combines cutting-edge research with tradition. The government&apos;s <strong>MEXT scholarship</strong> covers tuition, airfare, and monthly stipend—no repayment. <strong>Study in Japan for international students</strong> includes 100+ English-taught degrees under the SGU initiative, so you can earn a degree without fluent Japanese. Tech, engineering, and business programs are among the strongest globally.
          </p>
          <p className="mb-4">
            For Nepali applicants, the journey starts at the Japanese Embassy in Kathmandu. COE (Certificate of Eligibility) processing takes 2–3 months; visa issuance 5–10 working days. San Marina supports students from Kathmandu, Dang, and Itahari with MEXT prep, JLPT coaching, and university shortlisting.
          </p>
        </div>
      </section>

      {/* Is it Good to Study in Japan */}
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Is it Good to Study in Japan?</h2>
          <p className="text-lg text-gray-700 mb-6 font-medium">
            <strong>Quick answer:</strong> Yes. <strong>Is it good to study in Japan?</strong> Japan offers top-ranked universities, full MEXT funding, safe cities, strong job prospects in tech and manufacturing, and unique cultural immersion. Trade-offs: language learning curve for Japanese-taught programs, high cost in Tokyo. Many students choose Osaka or Kyoto for affordability.
          </p>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-8">
            <strong>In brief:</strong> <strong>Business studies in Japan</strong> thrive at Waseda, Keio, Hitotsubashi. IT and Engineering dominate at Tokyo Tech, Kyoto, Osaka. All offer English-taught options. Language schools provide 1–2 year JLPT prep for Japanese-medium programs.
          </p>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="font-bold text-[#001F3F] mb-2">Tokyo Living</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 mb-6">
            <strong>In brief:</strong> <strong>MEXT</strong> (Ministry of Education, Japan): full tuition waiver + airfare + monthly stipend. Undergrad ¥242,000/mo; Research (master&apos;s/PhD) ¥143,000–145,000/mo. Apply via Japanese Embassy Kathmandu (recommendation route). <a href="https://www.studyinjapan.go.jp/en/planning/scholarship/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">studyinjapan.go.jp</a>. <Link href="/scholarships/" className="text-blue-600 hover:underline">See all scholarships</Link>.
          </p>
      ...
      {/* Can You Study Without Japanese */}
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Can You Study in Japan Without Knowing Japanese?</h2>
        <p className="text-lg text-gray-700 mb-6 font-medium">
          <strong>Quick answer:</strong> <strong>Can I study in Japan without knowing Japanese?</strong> Yes. SGU (Super Global Universities) and G30 offer 100+ English-taught bachelor&apos;s and master&apos;s programs. Tokyo, Kyoto, Osaka, Waseda, Keio—all have English options. IELTS 6.0+ typically required.
        </p>
        <p className="text-gray-700 mb-4">
          That said, daily life, part-time work, and networking improve dramatically with Japanese. JLPT N3 opens convenience-store and restaurant jobs; N2 unlocks internships. Many students do 1–2 years at a language school first, then enter a Japanese-taught degree. We advise choosing based on your timeline and career goals.
        </p>
      </section>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-6">How Much Gap is Accepted for Study in Japan?</h2>
          <p className="text-lg text-gray-700 mb-4">
            <strong>In brief:</strong> <strong>How much gap is accepted for study in Japan?</strong> Typically 1–2 years if you provide a clear explanation. Gaps of 3+ years may need work experience or recent courses to show continuity. MEXT and top universities can be stricter—check each institution.
          </p>
          <p className="text-gray-700">
            Write a gap explanation letter with dates and activities. Part-time work, volunteering, or short courses help. San Marina helps applicants frame gaps effectively for Japanese universities and MEXT selection.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Intakes in Japan</h2>
      ...
      {/* Disadvantages */}
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-6">Disadvantages of Studying in Japan</h2>
        <p className="text-gray-700 mb-4">
          <strong>In brief:</strong> <strong>Disadvantages of studying in Japan</strong> include: language barrier for non-SGU students, high living cost in Tokyo (¥120,000+ /month), earthquake risk, rigid corporate culture, and limited English in daily life outside big cities.
        </p>
        <p className="text-gray-700">
      ...
      {/* Cities */}
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-[#001F3F] mb-8 text-center">Top Japanese Cities for Nepali Students</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#001F3F] mb-4 text-center">Why Choose Our Study in Japan Consultancy in Nepal?</h2>
          <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
            San Marina is a leading <strong>study in Japan consultancy in Nepal</strong>. We guide MEXT applications, JLPT preparation, COE process, and university selection. Offices in Kathmandu, Dang, and Itahari. <Link href="/about/" className="text-blue-600 hover:underline">QEAC certified</Link>.
          </p>
      ...
      <section className="py-16 bg-gradient-to-br from-[#0056b3] via-[#004494] to-[#003366] mb-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Study in Japan from Nepal?</h2>
